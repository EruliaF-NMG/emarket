...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_chat_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/chat.model */ \"./server/app/models/chat.model.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-02-01 11:57:49 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-02-01 12:28:45\n */\n\n\n\n\nvar getChatMessagers = function getChatMessagers(req, res) {\n  _models_chat_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find({\n    $or: [{\n      $and: [{\n        sender_id: req.params.mainUser\n      }, {\n        receiver_id: req.params.otherUser\n      }]\n    }, {\n      $and: [{\n        receiver_id: req.params.mainUser\n      }, {\n        sender_id: req.params.otherUser\n      }]\n    }]\n  }).sort({\n    created: 'desc'\n  }).exec(function (error, chatMessgers) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], chatMessgers));\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getChatMessagers: getChatMessagers\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/chat.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! socket.io */ \"socket.io\");\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(socket_io__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! http */ \"http\");\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(http__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _bootstrap_express__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bootstrap/express */ \"./server/bootstrap/express.js\");\n/* harmony import */ var _config_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./config/core */ \"./server/config/core.js\");\n/* harmony import */ var _app_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app/helpers/common/chatMessage */ \"./server/app/helpers/common/chatMessage.js\");\n\n\n\n\n\n // Connection URL\n\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Promise = global.Promise;\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connect(_config_core__WEBPACK_IMPORTED_MODULE_4__[\"mongoDBUrl\"], {\n  useNewUrlParser: true\n});\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connection.on('error', function () {\n  throw new Error(\"unable to connect to database: \".concat(_config_core__WEBPACK_IMPORTED_MODULE_4__[\"mongoDBUrl\"]));\n});\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.set('useCreateIndex', true); //mongoose.set('debug', true);\n\nvar server = http__WEBPACK_IMPORTED_MODULE_2___default.a.createServer(_bootstrap_express__WEBPACK_IMPORTED_MODULE_3__[\"default\"]); //socket IO\n\nvar io = socket_io__WEBPACK_IMPORTED_MODULE_1___default()(server);\nio.on('connection', function (socket) {\n  console.log('User connected');\n  socket.on('disconnect', function () {\n    console.log('user disconnected');\n  });\n  socket.on('message', function (msg) {\n    Object(_app_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_5__[\"addChat\"])(msg, function (error, responce) {\n      if (!error) {\n        io.emit('receive_message', responce);\n        console.log('message', responce);\n      }\n    }); //io.emit('receive_message', responce);\n  });\n});\nserver.listen(_config_core__WEBPACK_IMPORTED_MODULE_4__[\"port\"], function (err) {\n  if (err) {\n    console.log(err);\n  }\n\n  console.info('Server started on port %s.', _config_core__WEBPACK_IMPORTED_MODULE_4__[\"port\"]);\n});\n\n//# sourceURL=webpack:///./server/server.js?");
