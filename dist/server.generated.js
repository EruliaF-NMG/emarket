...
/***/ "./server/app/helpers/common/chatMessage.js":
/*!**************************************************!*\
  !*** ./server/app/helpers/common/chatMessage.js ***!
  \**************************************************/
/*! exports provided: addChat, getMessageList */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addChat\", function() { return addChat; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getMessageList\", function() { return getMessageList; });\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ \"lodash\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _models_chat_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../models/chat.model */ \"./server/app/models/chat.model.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-02-01 14:38:24 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-02-03 14:02:07\n */\n\n\n\nfunction addChat(data, cb) {\n  var formData = {\n    \"sender_id\": data.sender,\n    \"senderModel\": lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startCase(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.toLower(data.sender_type)),\n    \"receiver_id\": data.receiver,\n    \"receiverModel\": lodash__WEBPACK_IMPORTED_MODULE_0___default.a.startCase(lodash__WEBPACK_IMPORTED_MODULE_0___default.a.toLower(data.receiver_type)),\n    \"chat\": data.message,\n    \"type\": data.type\n  };\n  var chat = new _models_chat_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"](formData);\n  chat.save(function (err, message) {\n    if (err) {\n      cb(err);\n    } else {\n      _models_chat_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"].findById(message._id).populate('sender_id').populate('receiver_id').exec(function (error, msgObj) {\n        if (err) {\n          cb(err);\n        } else {\n          var sender = msgObj.senderModel == \"User\" ? msgObj.sender_id._id : msgObj.sender_id.owner;\n          var receiver = msgObj.receiverModel == \"User\" ? msgObj.receiver_id._id : msgObj.receiver_id.owner;\n          cb(null, message, sender, receiver);\n        }\n      });\n    }\n  });\n}\n\nfunction getMessageList(mainUser, otherUser, cb) {\n  _models_chat_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find({\n    $or: [{\n      $and: [{\n        sender_id: mainUser\n      }, {\n        receiver_id: otherUser\n      }]\n    }, {\n      $and: [{\n        receiver_id: mainUser\n      }, {\n        sender_id: otherUser\n      }]\n    }]\n  }).exec(function (error, chatMessgers) {\n    if (error) {\n      cb(error);\n    } else {\n      cb(null, chatMessgers);\n    }\n  });\n}\n\n\n\n//# sourceURL=webpack:///./server/app/helpers/common/chatMessage.js?");
...
/***/ "./server/app/helpers/product/manageProducts.js":
/*!******************************************************!*\
  !*** ./server/app/helpers/product/manageProducts.js ***!
  \******************************************************/
/*! exports provided: uploadProductGalary */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"uploadProductGalary\", function() { return uploadProductGalary; });\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _common_manageUploads__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/manageUploads */ \"./server/app/helpers/common/manageUploads.js\");\n\n\n\nvar uploadProductGalary = function uploadProductGalary(fileArray, cb) {\n  var returnFileLIst = [];\n  var itemcount = 0;\n\n  var _loop = function _loop(key) {\n    var newID = mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId();\n    Object(_common_manageUploads__WEBPACK_IMPORTED_MODULE_1__[\"uploadImage\"])(newID, fileArray[key], function (error) {\n      if (!error) {\n        returnFileLIst[key] = {\n          \"fileId\": newID,\n          \"type\": fileArray[key][\"mimetype\"]\n        };\n      }\n\n      itemcount++;\n\n      if (itemcount == fileArray.length) {\n        cb(null, returnFileLIst);\n      }\n    });\n  };\n\n  for (var key in fileArray) {\n    _loop(key);\n  }\n};\n\n\n\n//# sourceURL=webpack:///./server/app/helpers/product/manageProducts.js?");
...
/***/ "./server/app/http/controllers/category.controller.js":
/*!************************************************************!*\
  !*** ./server/app/http/controllers/category.controller.js ***!
  \************************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_category_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/category.model */ \"./server/app/models/category.model.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-01-24 15:27:31 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-01-24 17:14:59\n */\n\n\n\n\nvar create = function create(req, res) {\n  var formData = req.body;\n  var category = new _models_category_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"](formData);\n  category.save(function (error, categoryObj) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    } else {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], categoryObj));\n    }\n  });\n};\n\nvar getCategoryList = function getCategoryList(req, res) {\n  _models_category_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find({}, function (error, category) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], []));\n    } else {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], category));\n    }\n  }); // let catList = [\n  //     { name: \"Apparel,Textiles & Accessories\" },\n  //     { name: \"Gifts, Sports & Toys\" },\n  //     { name: \"Bags, Shoes & Accessories\" },\n  //     { name: \"Electronics\" },\n  //     { name: \"Home, Lights & Construction\" }\n  // ];\n  // Category.collection.insert(catList, function (err, docs) {\n  //     if (err){ \n  //         return console.error(err);\n  //     } else {\n  //       console.log(\"Multiple documents inserted to Collection\");\n  //     }\n  //   }); \n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  create: create,\n  getCategoryList: getCategoryList\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/category.controller.js?");

/***/ }),

/***/ "./server/app/http/controllers/chat.controller.js":
/*!********************************************************!*\
  !*** ./server/app/http/controllers/chat.controller.js ***!
  \********************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../config/core */ \"./server/config/core.js\");\n/* harmony import */ var _models_user_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../models/user.model */ \"./server/app/models/user.model.js\");\n/* harmony import */ var _models_shop_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../models/shop.model */ \"./server/app/models/shop.model.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/* harmony import */ var _helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../helpers/common/chatMessage */ \"./server/app/helpers/common/chatMessage.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-02-01 11:57:49 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-02-03 11:54:03\n */\n\n\n\n\n\n\n\nvar getChatMessagers = function getChatMessagers(req, res) {\n  Object(_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_5__[\"getMessageList\"])(req.params.mainUser, req.params.otherUser, function (error, messageList) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"], messageList));\n  });\n};\n\nvar initChatANDGetChatList = function initChatANDGetChatList(req, res) {\n  Object(_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_5__[\"getMessageList\"])(req.params.shopID, req.params.userID, function (error, messageList) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"], error));\n    }\n\n    if (req.params.type == \"user\") {\n      _models_user_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"].findById(req.params.userID).exec(function (error, user) {\n        if (error) {\n          return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"], error));\n        }\n\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"], {\n          \"receiver\": {\n            id: user._id,\n            name: user.name,\n            imgUrl: _config_core__WEBPACK_IMPORTED_MODULE_0__[\"baseUrl\"] + \"api/user/profile-image/\" + user._id,\n            key: req.params.shopID + \"_\" + req.params.userID\n          },\n          \"chatList\": messageList\n        }));\n      });\n    } else {\n      _models_shop_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findById(req.params.shopID).exec(function (error, shop) {\n        if (error) {\n          return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"exceptionResponse\"], error));\n        }\n\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_3__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_4__[\"successResponse\"], {\n          \"receiver\": {\n            id: shop._id,\n            name: shop.name,\n            imgUrl: _config_core__WEBPACK_IMPORTED_MODULE_0__[\"baseUrl\"] + \"api/shop-logo/\" + shop._id,\n            key: req.params.userID + \"_\" + req.params.shopID\n          },\n          \"chatList\": messageList\n        }));\n      });\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getChatMessagers: getChatMessagers,\n  initChatANDGetChatList: initChatANDGetChatList\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/chat.controller.js?");

/***/ }),

/***/ "./server/app/http/controllers/product.controller.js":
/*!***********************************************************!*\
  !*** ./server/app/http/controllers/product.controller.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! fs */ \"fs\");\n/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(fs__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _models_product_model__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../models/product.model */ \"./server/app/models/product.model.js\");\n/* harmony import */ var _helpers_product_manageProducts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/product/manageProducts */ \"./server/app/helpers/product/manageProducts.js\");\n/* harmony import */ var _helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../helpers/common/manageUploads */ \"./server/app/helpers/common/manageUploads.js\");\n/* harmony import */ var _helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../helpers/common/grid-fs */ \"./server/app/helpers/common/grid-fs.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-01-14 17:02:27 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-01-25 12:46:38\n */\n\n\n\n\n\n\n\n\n\nvar create = function create(req, res) {\n  Object(_helpers_product_manageProducts__WEBPACK_IMPORTED_MODULE_3__[\"uploadProductGalary\"])(req.files, function (error, galaryList) {\n    var formData = req.body;\n    formData[\"shop\"] = req.currentShop._id;\n    formData[\"gallery\"] = galaryList;\n    var product = new _models_product_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"](formData);\n    product.save(function (err, productObj) {\n      if (err) {\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n      } else {\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"], productObj));\n      }\n    });\n  });\n};\n\nvar getProductsByShop = function getProductsByShop(req, res) {\n  _models_product_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find({\n    shop: req.currentShop._id\n  }, function (error, products) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"], products));\n  });\n};\n\nvar getProductGalary = function getProductGalary(req, res, next) {\n  try {\n    var id = mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId(req.params.galaryID);\n    Object(_helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_4__[\"getImage\"])(id, function (error, file) {\n      if (error) {\n        next();\n      } else {\n        if (file) {\n          res.header('Content-Length', file.length);\n          res.header('Content-Type', file.contentType);\n          Object(_helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_5__[\"sendFileToResponce\"])(id, res, function (error) {\n            if (error) {\n              next();\n            }\n          });\n        } else {\n          next();\n        }\n      }\n    });\n  } catch (ex) {\n    next();\n  }\n};\n\nvar defaultProductImage = function defaultProductImage(req, res) {\n  res.header('Content-Type', \"image/png\");\n  fs__WEBPACK_IMPORTED_MODULE_1___default.a.ReadStream(\"./assets/default-product.png\").pipe(res).on(\"error\", function (error) {\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n  });\n};\n\nvar getProductByID = function getProductByID(req, res, next, id) {\n  _models_product_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].findById(id).populate({\n    path: 'shop',\n    model: 'Shop',\n    select: \"_id name description address contact\",\n    populate: {\n      path: 'owner',\n      model: 'User',\n      select: \"_id name email\"\n    }\n  }).exec(function (error, product) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n    }\n\n    req.currentProduct = product;\n    next();\n  });\n};\n\nvar getProductInfo = function getProductInfo(req, res) {\n  return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"], req.currentProduct));\n};\n\nvar getSimilarProducts = function getSimilarProducts(req, res) {\n  _models_product_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find({\n    category: req.currentProduct.category\n  }).limit(5).exec(function (error, products) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"], products));\n  });\n};\n\nvar getProductAll = function getProductAll(req, res) {\n  _models_product_model__WEBPACK_IMPORTED_MODULE_2__[\"default\"].find({}).exec(function (error, products) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_6__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_7__[\"successResponse\"], products));\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  create: create,\n  getProductsByShop: getProductsByShop,\n  getProductGalary: getProductGalary,\n  getProductByID: getProductByID,\n  getProductInfo: getProductInfo,\n  defaultProductImage: defaultProductImage,\n  getSimilarProducts: getSimilarProducts,\n  getProductAll: getProductAll\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/product.controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n\nvar categorySchema = new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({\n  name: {\n    type: String,\n    trim: true\n  },\n  updated: Date,\n  created: {\n    type: Date,\n    default: Date.now\n  }\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('Category', categorySchema));\n\n//# sourceURL=webpack:///./server/app/models/category.model.js?");

/***/ }),

/***/ "./server/app/models/chat.model.js":
/*!*****************************************!*\
  !*** ./server/app/models/chat.model.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n //Dynamic References \n\nvar chatSchema = new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({\n  sender_id: {\n    type: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema.ObjectId,\n    refPath: 'senderModel'\n  },\n  senderModel: {\n    type: String,\n    enum: ['User', 'Shop']\n  },\n  receiver_id: {\n    type: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema.ObjectId,\n    refPath: \"receiverModel\"\n  },\n  receiverModel: {\n    type: String,\n    enum: ['User', 'Shop']\n  },\n  chat: {\n    type: String,\n    trim: true\n  },\n  type: {\n    type: String,\n    trim: true\n  },\n  updated: Date,\n  created: {\n    type: Date,\n    default: Date.now\n  }\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('Chat', chatSchema));\n\n//# sourceURL=webpack:///./server/app/models/chat.model.js?");
...
/***/ "./server/app/models/product.model.js":
/*!********************************************!*\
  !*** ./server/app/models/product.model.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n\nvar productSchema = new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({\n  name: {\n    type: String,\n    trim: true\n  },\n  description: {\n    type: String,\n    trim: true\n  },\n  gallery: [{\n    fileId: {\n      type: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema.ObjectId\n    },\n    type: {\n      type: String,\n      trim: true\n    },\n    created: {\n      type: Date,\n      default: Date.now\n    }\n  }],\n  category: {\n    type: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema.ObjectId,\n    ref: \"Category\"\n  },\n  quantity: {\n    type: Number,\n    trim: true\n  },\n  price: {\n    type: Number,\n    trim: true\n  },\n  shop: {\n    type: mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema.ObjectId,\n    ref: \"Shop\"\n  },\n  updated: Date,\n  created: {\n    type: Date,\n    default: Date.now\n  }\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('Product', productSchema));\n\n//# sourceURL=webpack:///./server/app/models/product.model.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _http_controllers_category_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../http/controllers/category.controller */ \"./server/app/http/controllers/category.controller.js\");\n/* harmony import */ var _http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../http/controllers/auth.controller */ \"./server/app/http/controllers/auth.controller.js\");\n //controllers\n\n\n\nvar router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\nrouter.route(\"/category\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_category_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getCategoryList).post(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_category_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create);\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./server/app/routes/category.routes.js?");

/***/ }),

/***/ "./server/app/routes/chat.routers.js":
/*!*******************************************!*\
  !*** ./server/app/routes/chat.routers.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _http_controllers_chat_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../http/controllers/chat.controller */ \"./server/app/http/controllers/chat.controller.js\");\n/* harmony import */ var _http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../http/controllers/auth.controller */ \"./server/app/http/controllers/auth.controller.js\");\n //controllers\n\n\n\nvar router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\nrouter.route(\"/get-message-list/:mainUser/:otherUser\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_chat_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getChatMessagers);\nrouter.route(\"/init-chat-get-message-list/:shopID/:userID/:type\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_chat_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].initChatANDGetChatList);\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./server/app/routes/chat.routers.js?");

/***/ }),

/***/ "./server/app/routes/product.routes.js":
/*!*********************************************!*\
  !*** ./server/app/routes/product.routes.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! express */ \"express\");\n/* harmony import */ var express__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(express__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../http/controllers/product.controller */ \"./server/app/http/controllers/product.controller.js\");\n/* harmony import */ var _http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../http/controllers/auth.controller */ \"./server/app/http/controllers/auth.controller.js\");\n/* harmony import */ var _http_controllers_shop_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../http/controllers/shop.controller */ \"./server/app/http/controllers/shop.controller.js\");\n/* harmony import */ var _http_middleware_core_multipartFrom__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../http/middleware/core/multipartFrom */ \"./server/app/http/middleware/core/multipartFrom.js\");\n //controllers\n\n\n\n //middleware\n\n\nvar router = express__WEBPACK_IMPORTED_MODULE_0___default.a.Router();\nrouter.route(\"/product-create/:shopID\").post(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_middleware_core_multipartFrom__WEBPACK_IMPORTED_MODULE_4__[\"fileUpload\"].any(\"files\"), _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].create);\nrouter.route(\"/product/:shopID\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getProductsByShop);\nrouter.route(\"/product-info/:productID\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getProductInfo);\nrouter.route(\"/get-similar/:productID\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getSimilarProducts);\nrouter.route(\"/product-all\").get(_http_controllers_auth_controller__WEBPACK_IMPORTED_MODULE_2__[\"default\"].requireSignin, _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getProductAll);\nrouter.route(\"/product-galary/:galaryID\").get(_http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getProductGalary, _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].defaultProductImage);\nrouter.param(\"shopID\", _http_controllers_shop_controller__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getShopByID);\nrouter.param(\"productID\", _http_controllers_product_controller__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getProductByID);\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./server/app/routes/product.routes.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! socket.io */ \"socket.io\");\n/* harmony import */ var socket_io__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(socket_io__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! http */ \"http\");\n/* harmony import */ var http__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(http__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lodash */ \"lodash\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _bootstrap_express__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bootstrap/express */ \"./server/bootstrap/express.js\");\n/* harmony import */ var _config_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config/core */ \"./server/config/core.js\");\n/* harmony import */ var _app_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app/helpers/common/chatMessage */ \"./server/app/helpers/common/chatMessage.js\");\n\n\n\n\n\n\n // Connection URL\n\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Promise = global.Promise;\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connect(_config_core__WEBPACK_IMPORTED_MODULE_5__[\"mongoDBUrl\"], {\n  useNewUrlParser: true\n});\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connection.on(\"error\", function () {\n  throw new Error(\"unable to connect to database: \".concat(_config_core__WEBPACK_IMPORTED_MODULE_5__[\"mongoDBUrl\"]));\n});\nmongoose__WEBPACK_IMPORTED_MODULE_0___default.a.set(\"useCreateIndex\", true); //mongoose.set('debug', true);\n\nvar server = http__WEBPACK_IMPORTED_MODULE_2___default.a.createServer(_bootstrap_express__WEBPACK_IMPORTED_MODULE_4__[\"default\"]); //socket IO\n\nvar io = socket_io__WEBPACK_IMPORTED_MODULE_1___default()(server);\nvar clients = [];\nio.on(\"connection\", function (socket) {\n  socket.on(\"clientKey\", function (data) {\n    var clientInfo = new Object();\n    clientInfo.customId = data.customId;\n    clientInfo.clientId = socket.id;\n    clients.push(clientInfo);\n    console.log(\"connection\", clients);\n  });\n  socket.on(\"disconnect\", function () {\n    for (var i in clients) {\n      if (clients[i]['clientId'] == socket.id) {\n        clients.splice(i, 1);\n        break;\n      }\n    }\n\n    console.log(\"disconnect\", clients);\n  });\n  socket.on('forceDisconnect', function (id) {\n    socket.disconnect();\n  });\n  socket.on(\"message\", function (msg) {\n    Object(_app_helpers_common_chatMessage__WEBPACK_IMPORTED_MODULE_6__[\"addChat\"])(msg, function (error, responce, sender, receiver) {\n      if (!error) {\n        for (var i in clients) {\n          if (clients[i][\"customId\"] == sender) {\n            io.to(clients[i][\"clientId\"]).emit(\"receive_message\", responce);\n          } else if (clients[i][\"customId\"] == receiver) {\n            io.to(clients[i][\"clientId\"]).emit(\"receive_message\", responce);\n          }\n        }\n      }\n    });\n  });\n});\nserver.listen(_config_core__WEBPACK_IMPORTED_MODULE_5__[\"port\"], function (err) {\n  if (err) {\n    console.log(err);\n  }\n\n  console.info(\"Server started on port %s.\", _config_core__WEBPACK_IMPORTED_MODULE_5__[\"port\"]);\n});\n\n//# sourceURL=webpack:///./server/server.js?");
