...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_shop_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/shop.model */ \"./server/app/models/shop.model.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/* harmony import */ var _helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/common/manageUploads */ \"./server/app/helpers/common/manageUploads.js\");\n/* harmony import */ var _helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../helpers/common/grid-fs */ \"./server/app/helpers/common/grid-fs.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-01-12 14:05:38 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-01-12 21:38:46\n */\n\n\n\n\n\n\nvar getShopByID = function getShopByID(req, res, next, id) {\n  _models_shop_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].findById(id).populate('owner').exec(function (error, shop) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    }\n\n    req.currentShop = shop;\n    next();\n  });\n};\n\nvar getShopData = function getShopData(req, res) {\n  return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], req.currentShop));\n};\n\nvar create = function create(req, res) {\n  var formData = req.body;\n  formData[\"owner\"] = req.profile._id;\n  var shop = new _models_shop_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"](formData);\n  shop.save(function (err, shopObj) {\n    if (err) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    } else {\n      Object(_helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__[\"uploadImage\"])(shopObj._id, req.file, function (error) {\n        if (error) {\n          return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], shopObj));\n        } else {\n          return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], shopObj));\n        }\n      });\n    }\n  });\n};\n\nvar edit = function edit(req, res) {\n  var shop = req.currentShop;\n  Object(_helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__[\"uploadImage\"])(shop._id, req.file, function (error) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    } else {\n      shop.name = req.body.name;\n      shop.description = req.body.description;\n      shop.address = req.body.address;\n      shop.contact = req.body.contact;\n      shop.updated = Date.now();\n      shop.save(function (error, shopData) {\n        if (error) {\n          return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n        }\n\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], shopData));\n      });\n    }\n  });\n};\n\nvar getShopsByUser = function getShopsByUser(req, res) {\n  _models_shop_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].find({\n    owner: req.profile._id\n  }, function (error, shops) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"successResponse\"], shops));\n  });\n};\n\nvar getShopLogo = function getShopLogo(req, res, next) {\n  Object(_helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__[\"getImage\"])(req.currentShop._id, function (error, file) {\n    if (error) {\n      next();\n    } else {\n      if (file) {\n        res.header('Content-Length', file.length);\n        res.header('Content-Type', file.contentType);\n        Object(_helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_4__[\"sendFileToResponce\"])(req.currentShop._id, res, function (error) {\n          if (error) {\n            next();\n          }\n        });\n      } else {\n        next();\n      }\n    }\n  });\n};\n\nvar defaultShopImage = function defaultShopImage(req, res) {\n  res.header('Content-Type', \"image/png\");\n  fs.ReadStream(\"./assets/default-profile-img.png\").pipe(res).on(\"error\", function (error) {\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_1__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_2__[\"exceptionResponse\"], error));\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getShopByID: getShopByID,\n  getShopsByUser: getShopsByUser,\n  create: create,\n  edit: edit,\n  getShopLogo: getShopLogo,\n  defaultShopImage: defaultShopImage,\n  getShopData: getShopData\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/shop.controller.js?");
