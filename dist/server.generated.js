...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _models_product_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../models/product.model */ \"./server/app/models/product.model.js\");\n/* harmony import */ var _helpers_product_manageProducts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../helpers/product/manageProducts */ \"./server/app/helpers/product/manageProducts.js\");\n/* harmony import */ var _helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../helpers/common/manageUploads */ \"./server/app/helpers/common/manageUploads.js\");\n/* harmony import */ var _helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../helpers/common/grid-fs */ \"./server/app/helpers/common/grid-fs.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/*\n * @Author: Nisal Madusanka(EruliaF) \n * @Date: 2019-01-14 17:02:27 \n * @Last Modified by: Nisal Madusanka(EruliaF)\n * @Last Modified time: 2019-01-20 21:12:28\n */\n\n\n\n\n\n\n\n\nvar create = function create(req, res) {\n  Object(_helpers_product_manageProducts__WEBPACK_IMPORTED_MODULE_2__[\"uploadProductGalary\"])(req.files, function (error, galaryList) {\n    var formData = req.body;\n    formData[\"shop\"] = req.currentShop._id;\n    formData[\"gallery\"] = galaryList;\n    var product = new _models_product_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"](formData);\n    product.save(function (err, productObj) {\n      if (err) {\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_5__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"exceptionResponse\"], error));\n      } else {\n        return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_5__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"successResponse\"], productObj));\n      }\n    });\n  });\n};\n\nvar getProductsByShop = function getProductsByShop(req, res) {\n  _models_product_model__WEBPACK_IMPORTED_MODULE_1__[\"default\"].find({\n    shop: req.currentShop._id\n  }, function (error, products) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_5__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"exceptionResponse\"], error));\n    }\n\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_5__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_6__[\"successResponse\"], products));\n  });\n};\n\nvar getProductGalary = function getProductGalary(req, res, next) {\n  var id = mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Types.ObjectId(req.params.galaryID);\n  Object(_helpers_common_manageUploads__WEBPACK_IMPORTED_MODULE_3__[\"getImage\"])(id, function (error, file) {\n    if (error) {\n      console.log(error);\n      next();\n    } else {\n      if (file) {\n        console.log(file);\n        res.header('Content-Length', file.length);\n        res.header('Content-Type', file.contentType);\n        Object(_helpers_common_grid_fs__WEBPACK_IMPORTED_MODULE_4__[\"sendFileToResponce\"])(id, res, function (error) {\n          if (error) {\n            console.log(error);\n            next();\n          }\n        });\n      } else {\n        console.log(file);\n        next();\n      }\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  create: create,\n  getProductsByShop: getProductsByShop,\n  getProductGalary: getProductGalary\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/product.controller.js?");
