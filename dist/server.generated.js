...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_user_model__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../models/user.model */ \"./server/app/models/user.model.js\");\n/* harmony import */ var _config_apiResponse__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../config/apiResponse */ \"./server/config/apiResponse.js\");\n/* harmony import */ var _helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../helpers/common/commonMethods */ \"./server/app/helpers/common/commonMethods.js\");\n\n\n\n\nvar getUserByID = function getUserByID(req, res, next, id) {\n  _models_user_model__WEBPACK_IMPORTED_MODULE_0__[\"default\"].findById(id).exec(function (error, user) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_2__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"exceptionResponse\"], error));\n    }\n\n    req.profile = user;\n    next();\n  });\n};\n\nvar getProfileInfo = function getProfileInfo(req, res) {\n  req.profile.salt = undefined;\n  req.profile.hashed_password = undefined;\n  return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_2__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"successResponse\"], req.profile));\n};\n\nvar updateUser = function updateUser(req, res) {\n  var user = req.profile;\n  user.email = req.body.email;\n  user.name = req.body.name;\n  user.profile.about = req.body.about;\n  user.profile.address = req.body.address;\n  user.profile.contact = req.body.contact;\n  user.updated = Date.now();\n  user.save(function (error, userdata) {\n    if (error) {\n      return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"exceptionResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_2__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"exceptionResponse\"], error));\n    }\n\n    userdata.salt = undefined;\n    userdata.hashed_password = undefined;\n    return res.status(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"successResponse\"].httpStatus).json(Object(_helpers_common_commonMethods__WEBPACK_IMPORTED_MODULE_2__[\"_sendResponse\"])(_config_apiResponse__WEBPACK_IMPORTED_MODULE_1__[\"successResponse\"], userdata));\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  getUserByID: getUserByID,\n  getProfileInfo: getProfileInfo,\n  updateUser: updateUser\n});\n\n//# sourceURL=webpack:///./server/app/http/controllers/user.controller.js?");
